...
// Play button to start le level, info shown wit inventory, items damage and stuff, back to level selection screen thingy, submerged audio if not already playing, and quit button 

var gameBroke = false;

var gameAudio = false;

//Start with audio washed out (underswater, down volume and reverb up) *add later
var gamePause = true;
